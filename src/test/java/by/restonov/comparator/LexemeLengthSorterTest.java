...
public class LexemeLengthSorterTest extends Assert {
    ...
    @Test
    public void compareByLexemeLengthPositiveTest() {
        int actual = TextComparator.LEXEME_LENGTH.compare(equalSentence1, equalSentence2);
        int expected = 0;
        assertEquals(actual, expected);
    }

    @Test
    public void compareByLexemeLengthNegativeTest() {
        int actual = TextComparator.LEXEME_LENGTH.compare(equalSentence1, notEqualSentence);
        int expected = 0;
